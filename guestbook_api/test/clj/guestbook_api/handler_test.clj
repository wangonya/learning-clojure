(ns guestbook-api.handler-test
  (:require
    [clojure.test :refer :all]
    [ring.mock.request :refer :all]
    [guestbook-api.handler :refer :all]
    [guestbook-api.middleware.formats :as formats]
    [muuntaja.core :as m]
    [mount.core :as mount]))
...
(use-fixtures
  :once
  (fn [f]
    (mount/start #'guestbook-api.config/env
                 #'guestbook-api.handler/app-routes)
    (f)))
